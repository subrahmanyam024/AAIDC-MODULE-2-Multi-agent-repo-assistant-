...
This system demonstrates core multi-agent concepts:
...
- **LLM Integration**: Cohere for content generation and analysis

## ✨ Key Features

### Multi-Agent System
1. **Repository Analyzer Agent** - Extracts structure, files, and metadata
2. **Embedding Agent** - Manages semantic embeddings via Jina and Qdrant
3. **Metadata Recommender Agent** - Suggests project metadata and tags
4. **Content Improver Agent** - Enhances README using LLM
5. **Reviewer Agent** - Validates and provides feedback
6. **QA Agent** - Answers questions about repositories
7. **Integration Agent** - Coordinates with external services

### Tools Integration
1. **File Loader Tool** - Extracts and processes repository files
2. **Text Splitter Tool** - Chunks text for embedding (LangChain-based)
3. **Code Analyzer Tool** - Analyzes code structure, complexity, and patterns
4. **Web Search Tool** - Searches documentation and GitHub
5. **Vector Store Tool** - Manages Qdrant vector database operations
...
- Provide your API keys securely
- Run analysis and view results in your browser
